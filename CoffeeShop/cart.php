...
<body>
    ...
    <header>
        ...
        <div class="icons">
            ...
            <a href="#" class="fas fa-shopping-cart">السلة</a>
        </div>
    ...
    if (!empty($_SESSION["shopping_cart"])) {
        ...
        <div class="cart">
            ...
            <div class="table-responsive" id="order_table">
                <table class="table table-bordered table-stripped">
                    <tr>
                        ...
                        <th width="25%">الانواع</th>
                        <th width="10%">السعر</th>
                        <th width="10%">الكمية</th>
                        <th width="10%">الاضافات</th>
                        <th width="10%">الاجمالي</th>
                        <th width="10%">
                            <button class="btn2 btn-default btn-xs clear"> الغاء </button>
                        </th>
                    ...
                    foreach ($_SESSION["shopping_cart"] as $keys => $values) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="delete" id="<?php echo $values['product_id'] ?>"> <i class="fas fa-trash"></i>
                                </button>
                            </td>
                        </tr>
            ...
            <div class="place_order">
                <button class="btn" id="check_out">دفع</button>
            </div>
    ...
    <?php } else {
        ...
        <div class="empty_cart">
            ...
            <h1>
                <a href="index.php"><i class="fas fa-arrow-left"></i></a>عربة التسوق الخاصه بك فارغه
            </h1>
        </div>
