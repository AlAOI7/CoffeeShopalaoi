...
<body>
    ...
    <section class="offer" id="offer">
        ...
        <h1 align="center">
            <a href="index.php"><i class="fas fa-arrow-left"></i></a>العروض
        </h1>
        ...
        while($row=mysqli_fetch_assoc($result)){
            ...
            <div class="box" id="box">
                ...
                <div class="image">
                    ...
                    <img id="image_<?php echo $row2['item_id'] ?>" src="./<?php echo $row2["item_image"] ?>"
                        alt="product image">
                </div>
                ...
                <div class="content">
                    ...
                    <!-- add to cart buttons -->
                    <button id="<?php echo $row2['item_id'] ?>" class="btn addItemToCart"><i
