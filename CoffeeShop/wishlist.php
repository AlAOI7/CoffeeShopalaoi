...
<body>
    ...
    <header>
        ...
        <div class="icons">
            <a href="#" class="fas fa-heart">المفضلة</a>
    ...
    <section class="wishlist">
        ...
        <div class="products-container">
            ...
            <h3 class="title"><a href="./index.php"><i class="fas fa-arrow-left"></i></a> المفضلة</h3>
            ...
            <div class="box-container">
                ...
                <div class="box">
                    ...
                    <img src="<?php echo $values['product_image'] ?>" id="image_<?php echo $values['product_id'] ?>"
                        alt="">
                    ...
                    <div class="content">
                        ...
                        <button class="btn addItemToCart" id="<?php echo $values['product_id'] ?>"><i
                                class="fas fa-cart-plus"></i> اضافة الى السلة</button>
                    </div>
                </div>
                <?php } ?>
    ...
    <div class="empty_wishlist">
        ...
        <h1>
            <a href="index.php"><i class="fas fa-arrow-left"></i></a>قائمة المفضلة خالية
        </h1>
    </div>
    <?php } 
