                    ...
                    <div class="tabbed_area">
                        ...
                        <ul class="tabs">
                            <li><a href="javascript:tabSwitch('tab_1', 'content_1');" id="tab_1" class="active">عرض
                                    قائمة الفئات </a></li>
                            <li><a href="javascript:tabSwitch('tab_2', 'content_2');" id="tab_2">اضافة فئات</a></li>
                        </ul>
                                    ...
                                    <div class="card">
                                        ...
                                        while($row = mysqli_fetch_assoc($result)){ ?>
                                            ...
                                            <div class="menu_card">
                                                ...
                                                <div class="img">
                                                    <img class="menu_logo" id="image_<?php echo $row['menu_id'] ?>"
                                                        src="../../images/menu/<?php echo $row['menu_logo'] ?>" />
                                                </div>
                                                <div class="info">
                                                    <span class="menu_name"
                                                        id="name_<?php echo $row['menu_id'] ?>"><?php echo $row['menu_name'] ?></span>
                                                </div>
                                ...
                                <table width="220" height="106" border="0">
                                    ...
                                    <tr>
                                        <td align="center"><input name="name" type="text" style="width:100%"
                                                placeholder="اسم القائمة" required="required" id="add_menu_name" /></td>
                                    </tr>
                                    <tr>
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-body">
                                                        <form action="" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-sm-3 col-md-4 control-label">Menu
                                                                    Name</label>
                                                                <div class="col-sm-8">
