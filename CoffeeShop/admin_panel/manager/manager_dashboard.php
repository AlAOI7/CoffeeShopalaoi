        ...
        <div id="content">
            ...
            <div class="main-content">
                ...
                <div class="row">
                        ...
                        <div class="card card-stats">
                            <div class="card-header">
                                <div class="icon icon-warning">
                                    <span class="material-icons">alaoi</span>
                                </div>
                            </div>
                            ...
                            <div class="card-footer">
                                <div class="stats">
                                    ...
                                    <a href="view_reviews.php">رؤية التقارير المفصلة</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-stats">
                            <div class="card-header">
                                <div class="icon icon-rose">
                                    <span class="material-icons">التسوق</span>

                                </div>
                            </div>
                            <div class="card-content">
                                <p class="category"><strong>الطلبات</strong></p>
                                <h3 class="card-title"><?php echo $row['nb'] ?></h3>
                            </div>
                            <div class="card-footer">
                                <div class="stats">
                                    <i class="material-icons">عروض محلية</i>
                        ...
                        <div class="card card-stats">
                            <div class="card-header">
                                <div class="icon icon-success">
                                    <span class="material-icons">ارفاق المال</span>

                                </div>
                            </div>
                            <div class="card-content">
                                <p class="category"><strong>ربح</strong></p>
                                <h3 class="card-title">$<?php echo $row['nb'] ?></h3>
                            </div>
                            <div class="card-footer">
                                <div class="stats">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        ...
                        <div class="card card-stats">
                            ...
                            <div class="card-footer">
                                <div class="stats">
                                    <i class="material-icons">تحديث</i> تم التحديث للتو
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                ?>
                    ...
                    <input type="button" id="delivery" value="نغيير تكلفة التوصيل" />
                ...
                <input type="button" id="curr" value="اضافة عمله" />
