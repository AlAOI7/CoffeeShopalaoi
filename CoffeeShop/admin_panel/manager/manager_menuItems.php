...
<head>
    ...
    <title>ادارة قائمة العناصر</title>
...
?>
                ...
                <div id="tabbed_box" class="tabbed_box">
                    ...
                    <div class="tabbed_area">
                        ...
                        <ul class="tabs">
                            ...
                            <li><a href="javascript:tabSwitch('tab_2', 'content_2');" id="tab_2">اضافة عناصر</a></li>
                        </ul>
                                    ...
                                    <div class="card">
                                       ...
                                       FROM menuitem m1,menu m2 WHERE m1.menu_id=m2.menu_id";
                                        ...
                                        while($row = mysqli_fetch_assoc($result)){ ?>
                                                ...
                                                <div class="item_card item_<?php echo $row['item_id']; ?> <?php if($row['menu_id'] == 1){echo 'show';} ?>"
                                                    id="<?php  echo $row['menu_name']; ?>">
                                                    <div class="card-img">
                                                        <img id="image_<?php  echo $row['item_id']; ?>"
                                                            src="../../<?php echo $row['item_image'] ?>">
                                                    </div>
                                                    <div class="card-info">
                                                        <p class="text-title" id="name_<?php echo $row['item_id']; ?>">
                                                            <?php echo $row['item_name'] ?></p>
                                                        <p class="text-body" id="desc_<?php  echo $row['item_id']; ?>">
                                                            <?php echo $row['item_description'] ?></p>
                                                    </div>
                                                    <div class="card-footer">
                                                        <span class="text-title">$<span
                                                                id="price_<?php  echo $row['item_id']; ?>"><?php echo $row['item_price'] ?></span></span>
                                                        <div class="card-button">
                                                            <button class="update_item"
                                                        ...
                                                        <div class="card-button">
                                                            <button class="delete_item"
                                                                ...
                                                                <span class="iconify"
                                                                    ...
                                                                    style="color:#030;" data-width="30"
                                                                    data-height="309">حذف</span>
                                                            </button>
                                ...
                                <table width="220" height="106" border="0">
                                    ...
                                    <tr>
                                        <td align="center"><input name="name" type="text" style="width:100%"
                                                placeholder="اسم العنصر" required="required" id="add_item_name" /></td>
                                    </tr>
                                    <tr>
                                        <td align="center"><input name="price" type="text" style="width:100%"
                                                placeholder="السعر" required="required" id="add_item_price" /></td>
                                    </tr>
                                    <tr>
                                        <td align="center"><input name="description" type="text" style="width:100%"
                                                placeholder="الوصف" required="required" id="add_item_description" />
                                        </td>
                                    </tr>
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-body">
                                                        <form action="" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-sm-3 col-md-4 control-label">اسم
                                                                    العنصر</label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control" name="in"
                                                                        id="in" required="required">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <input type="hidden" value="" id="hidden_menu"
                                                                name="hidden_menu" />
    ...
    menuTabs.addEventListener("change", function(e) {
        if (e.target.options[e.target.options.selectedIndex].classList.contains("menu-tab-item") && !e.target
            .options[e.target.options.selectedIndex].classList.contains("show")) {
