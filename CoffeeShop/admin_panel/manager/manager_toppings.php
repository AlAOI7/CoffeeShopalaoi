                    ...
                    <div class="tabbed_area">
                        ...
                        <ul class="tabs">
                            <li><a href="javascript:tabSwitch('tab_1', 'content_1');" id="tab_1" class="active">
                                    عرض الاضافات</a></li>
                            <li><a href="javascript:tabSwitch('tab_2', 'content_2');" id="tab_2">اضافة</a></li>
                        </ul>
                                    ...
                                    <div class="card">
                                        ...
                                        while($row = mysqli_fetch_assoc($result)){ ?>
                                            <option class="menu-tab-item"
                                                data-target="#<?php echo $row['topping_category_name'] ?>">
                                       ...
                                       FROM toppings t1,toppingscategory t2 WHERE t1.topping_category_id=t2.topping_category_id";
                                        ...
                                        while($row = mysqli_fetch_assoc($result)){ ?>
                                                ...
                                                <div class="toppings_info topping_<?php echo $row['topping_id']; ?> <?php if($row['topping_category_id'] == 1){echo 'show';} ?>"
                                                    id="<?php  echo $row['topping_category_name']; ?>">
                                                    <div class="topping-img">
                                                        <img id="image_<?php  echo $row['topping_id']; ?>"
                                                            src="../../<?php echo $row['topping_image'] ?>">
                                                    </div>

                                                    <div class="card-title">
                                                        <span
                                                            id="name_<?php echo $row['topping_id']; ?>"><?php echo $row['topping_name'] ?></span>

                                                        <span>price:<span class="topping-price"
                                                                id="price_<?php  echo $row['topping_id']; ?>"><?php echo $row['topping_price'] ?>$</span></span>
                                                    </div>

                                                    <div class="card-button">
                                                        <button class="update_topping"
                                                            id="<?php echo $row['topping_id'] ?>">
                                ...
                                <table width="220" height="106" border="0">
                                    ...
                                    <tr>
                                        <td align="center"><input name="name" type="text" style="width:100%"
                                                placeholder="اسم الاضافة" required="required" id="add_topping_name" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center"><input name="price" type="text" style="width:100%"
                                                placeholder="السعر" required="required" id="add_topping_price" /></td>
                                    </tr>
                                                    ...
                                                    <div class="panel-body">
                                                        <form action="" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <label class="col-sm-3 control-label">انقر لتغيير
                                                                    الصورة</label>
                                                                <div class="col-sm-8">
