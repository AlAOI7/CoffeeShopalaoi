                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td id="name_<?php echo $row['topping_category_id'] ?>">
                                                            <?php echo $row['topping_category_name']; ?></td>

                                                        <td>
                                                            <button class="update_toppingCat"
                                                                id="<?php echo $row['topping_category_id'] ?>">
                                                        ...
                                                        <td>
                                                            <button class="delete_toppingCat"
                                                                id="<?php echo $row['topping_category_id'] ?>">
                                                                <span class="iconify"
                                ...
                                <table width="220" height="106" border="0">
                                    ...
                                    <tr>
                                        <td align="center"><input name="name" type="text" style="width:100%"
                                                placeholder="اسم الفئة" required="required" id="add_toppingCat_name" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right"><input type="submit" value="اضافة" name="submit"
                                                class="add_toppingCat" /></td>
                                    </tr>
                                </table>
                            </form>
                        </div>
