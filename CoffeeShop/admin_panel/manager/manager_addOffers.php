                    ...
                    <div class="tabbed_area">
                        ...
                        <ul class="tabs">
                            <li><a href="javascript:tabSwitch('tab_1', 'content_1');" id="tab_1" class="active">
                                    العروض</a></li>
                            <li><a href="javascript:tabSwitch('tab_2', 'content_2');" id="tab_2">اضافة عرض </a></li>
                        </ul>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <input type="button" id="delete_finished_offers"
                                                value="حذف العروض المنتهيه" />
                                            <input type="button" id="delete_all_offers" value="حذف كل العروض" />
                                        ...
                                        while($row = mysqli_fetch_assoc($result)){ 
                                            ...
                                            ?>
                                                ...
                                                <div class="item_card">
                                                    <div class="card-img">
                                                        <img id="image_<?php echo $row['offer_id']; ?>"
                                                            src="../../<?php echo $row['item_image'] ?>">
                                                    </div>
                                                    <div class="card-info">
                                                        <p class="text-title" id="name_<?php echo $row['offer_id']; ?>">
                                                    ...
                                                    <input type="hidden" value="<?php echo $row['pourcentage'] ?>"
                                                        id="pourcentage_<?php echo $row['offer_id']; ?>" />
                                                    <input type="hidden" value="<?php echo $row['item_price'] ?>"
                                                        id="oldprice_<?php echo $row['offer_id']; ?>" />

                                                    <div class="card-footer">

                                                        <span class="text-title">بداية التاريخ: <span
                                                                id="sd_<?php  echo $row['offer_id']; ?>"><?php echo $row['start_date'] ?></span></span>
                                                        <span class="text-title">نهاية التاريخ: <span
                                                                id="ed_<?php  echo $row['offer_id']; ?>"><?php echo $row['end_date'] ?></span></span>
                                                        <span class="warning_mess"><?php echo $message; ?></span>

                                                        <div class="card-button">
                                                            <button class="update_offer"
                        ...
                        <div id="content_2" class="content">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <table width="220" height="106" border="0">
                                    ...
                                    <tr>
                                        <td align="center"><input name="pourcentage" type="text" style="width:100%"
                                                placeholder="نسبه التخفيض" required="required" /></td>
                                    </tr>
                                    <tr>
                                        <td align="center"><input name="start_date" type="date" style="width:100%"
                                                required="required" /></td>
                                    </tr>
                                    <tr>
                                        <td align="center"><input name="end_date" type="date" style="width:100%"
                                                required="required" /></td>
                                    </tr>
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-body">
                                                        <form action="" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-sm-3 col-md-4 control-label">نسبة
                                                                    العرض</label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control" name="p"
                                                                        id="p" required="required">
                                                                </div>
                                                            </div>

                                                            <div class="form-group">
                                                                <label class="col-sm-3 col-md-4 control-label">تاريخ
                                                                    الانتهاء
                                                                </label>
                                                                <div class="col-sm-8">
