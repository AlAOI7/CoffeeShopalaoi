    ...
    <div class="content">
        ...
        <div class="main">
            ...
            <section class="container">
                ...
                <div class="login">
                    <img src="../images/log.png" style="   width: 140px;height: 120px;">

                    <?php echo $message; ?>

                    <form method="post" action="" align="center">

                        <input type="text" name="username" value="" placeholder="اسم المستخدم" required>
                        <input type="password" name="password" value="" placeholder="كلمة السر" required>
                        <select name="position">
                            <option style="display:none;">سجل دخول......</option>
                            <option>Admin</option>
