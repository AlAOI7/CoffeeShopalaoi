            ...
            <div class="main-content">
                <div id="tabbed_box" class="tabbed_box">
                    ...
                    <div class="tabbed_area">
                        ...
                        <ul class="tabs">
                            <li><a href="javascript:tabSwitch('tab_1', 'content_1');" id="tab_1" class="active">
                                    عرض الادارة</a></li>
                            <li><a href="javascript:tabSwitch('tab_2', 'content_2');" id="tab_2">اضافة مشرف </a></li>
                        </ul>
                                        ...
                                        <div class="card-content table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><img src="../../images/managers/<?php echo $row['manager_image']; ?>"
                                                                class="round_img"
                                                                id="image_<?php echo $row['manager_id'] ?>" /></td>
                                                        <td id="name_<?php echo $row['manager_id'] ?>">
                                                            <?php echo $row['manager_name']; ?></td>
                                                        <td id="phone_<?php echo $row['manager_id'] ?>">
                                                            <?php echo $row['manager_phone']; ?></td>
                                                        <td id="email_<?php echo $row['manager_id'] ?>">
                                                            <?php echo $row['manager_email']; ?></td>
                                                        <td id="username_<?php echo $row['manager_id'] ?>">
                                                            <?php echo $row['manager_username']; ?></td>
                                                        <td id="password_<?php echo $row['manager_id'] ?>">
                                                            <?php echo $row['manager_password']; ?></td>

                                                        <td>
                                                            <button class="update_manager"
                                                                id="<?php echo $row['manager_id'] ?>">
                                                    ...
                                                    <div class="panel-body">
                                                        <form action="" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <label class="col-sm-3 control-label">اضفط لتغيير
                                                                    الخلفية</label>
                                                                <div class="col-sm-8">
