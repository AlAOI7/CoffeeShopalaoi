                    ...
                    <div class="tabbed_area">
                        ...
                        <ul class="tabs">
                            <li><a href="javascript:tabSwitch('tab_1', 'content_1');" id="tab_1" class="active">عرض
                                    المسؤولين</a></li>
                            <li><a href="javascript:tabSwitch('tab_2', 'content_2');" id="tab_2">اضافة المسؤولين</a>
                            </li>
                        </ul>
                                        ...
                                        <div class="card-content table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><img src="../../images/admins/<?php echo $row['admin_image']; ?>"
                                                                class="round_img"
                                                                id="image_<?php echo $row['admin_id'] ?>" /></td>
                                                        <td id="name_<?php echo $row['admin_id'] ?>">
                                                            <?php echo $row['admin_name']; ?></td>
                                                        <td id="phone_<?php echo $row['admin_id'] ?>">
                                                            <?php echo $row['admin_phone']; ?></td>
                                                        <td id="email_<?php echo $row['admin_id'] ?>">
                                                            <?php echo $row['admin_email']; ?></td>
                                                        <td id="username_<?php echo $row['admin_id'] ?>">
                                                            <?php echo $row['admin_username']; ?></td>
                                                        <td id="password_<?php echo $row['admin_id'] ?>">
                                                            <?php echo $row['admin_password']; ?></td>

                                                        <td>
                                                            <button class="update_admin"
                                ...
                                <table width="220" height="106" border="0">
                                    ...
                                    <tr>
                                        <td align="center"><input name="name" type="text" style="width:100%"
                                                placeholder="اسم المشرف" required="required" id="add_admin_name" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center"><input name="phone" type="text" style="width:100%"
                                                placeholder="رقم الهاتف" required="required" id="add_admin_phone" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center"><input name="email" type="email" style="width:100%"
                                                placeholder="البريد" required="required" id="add_admin_email" /></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="center"><input name="password" type="text" style="width:100%"
                                                placeholder="كلمة السر" required="required" id="add_admin_password" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right"><input type="submit" value="اضافه" name="submit"
                                                class="add_admin" /></td>
                                    </tr>
                                </table>
                            </form>
                                                    ...
                                                    <div class="panel-body">
                                                        <form action="" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <label class="col-sm-3 control-label">تغيير
                                                                    الصورة</label>
                                                                <div class="col-sm-8">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-sm-3 col-md-4 control-label">
                                                                    اسم المستخدم</label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control" name="au"
                                                                        id="au" required="required">
                                                                </div>
                                                            </div>
