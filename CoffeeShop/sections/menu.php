<section class="menu" id="menu">
    <h3 class="sub-heading" data-aos="fade-up"> القائمة </h3>
    <h1 class="heading" data-aos="fade-up"> تخصصات الايام </h1>
...
?>
        ...
        <div class="box menu-tab-content <?php if($row['menu_id'] == 1){echo 'show';} ?>" data-aos="fade-up"
            ...
            <div class="content">
                ...
                <!-- add to cart button -->
                <button class="btn addItemToCart" id="<?php echo $row['item_id'] ?>"><i class="fas fa-cart-plus"></i>
