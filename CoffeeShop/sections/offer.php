<section class="offers" id="offers">
    ...
    <h3 class="sub-heading" data-aos="fade-up"> الساخنه </h3>
    <h1 class="heading" data-aos="fade-up"> منتجات رائجة! </h1>
        ...
        <div class="grid-banner">
            ...
            <div class="grid" data-aos="fade-up">
                ...
                <div class="content">
                    ...
                    <a href="./offers_list.php?section=1" class="btn">عرض</a>
                </div>
            </div>
            ...
            <div class="grid" data-aos="fade-up">
                ...
                <div class="content">
                    ...
                    <h3>ساخن</h3>
                    <a href="./offers_list.php?section=2" class="btn">عرض</a>
                </div>
            </div>
