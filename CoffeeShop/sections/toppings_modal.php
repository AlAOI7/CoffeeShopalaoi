        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="items">
                    ...
                    <div>
                        <h3 id="TOPPINGS">اختارالاضافات (اختيارية):</h3>
                                ...
                                <div class="topping_item">
                                    ...
                                    <label class="container2">
                                        <input type="checkbox" class="checkitem"
                                            value="<?php echo $row2['topping_name'] ?>">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn-secondary" id="btn-close" data-dismiss="modal">اغلاق</button>
                    <button type="button" class="btn-primary" id="btn-addToCart"> <i class="fas fa-cart-plus"></i>
                        السلة</button>
                </div>
            </div>
        </div>
