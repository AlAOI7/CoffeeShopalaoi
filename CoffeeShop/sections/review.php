<section class="review" id="review">
    ...
    <h3 class="sub-heading" data-aos="fade-up"> رؤية العملاء </h3>
    <h1 class="heading" data-aos="fade-up"> ماذا تريد ان تراء </h1>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-4 text-center">
                        ...
                        <h3><span id="total_review">0</span>مرجعات</h3>
                    </div>
                    ...
                    <div class="col-sm-4 text-center">
                        <h3 class="mt-4 mb-3">اكتب رائيك هنه</h3>
                        <button type="button" name="add_review" id="add_review" class="btn">انظر</button>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">اتقر لكي تراء</h5>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group text-center mt-4">
                    <button type="button" class="btn" id="save_review">موافق</button>
                    <button type="button" class="btn btn-default" id="cancel_review">الغاء</button>
                </div>
            </div>
        </div>
    </div>
